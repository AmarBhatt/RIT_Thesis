...
\begin{figure}
\centering
\includegraphics[scale=.85]{images/maze_world_example.png}
...
\section{DQN}
\subsection{Using Experience Replay}
\subsection{Using DDQN}
