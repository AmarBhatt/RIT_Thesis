...
\begin{itemize}
  ...
  \item DRQN Utilization: Utilizing the concept of recurrent neural networks and LSTMs to learn sequential tasks
\end{itemize}
...
\subsection{Using Deep Recurrent Q-Networks (DRQN)}
...
\begin{itemize}
 ...
 \item \textit{DRQN-AL}: Deep Recurrent Q-Network for Apprenticeship Learning which uses the DRQN architecture with experience replay modifications explained in Section~\ref{sec:drqn-implementation}.
\end{itemize}
...
\hline
  & \begin{tabular}[c]{@{}l@{}}Epochs\\ (Expert/Agent)\end{tabular} & $\alpha$ & SER & SED & SEDF \\ \hline
DAL~\cite{markovikj2014deep}  & 50000,100000 & 0.01 & - & - & - \\ \hline
DAL~\cite{markovikj2014deep} (no pooling)  & 50000,100000 & 0.01 & - & - & - \\ \hline
DAL with Transfer Learning  & 10000,10000 & 0.01 & - & - &  \\ \hline
DAL with Bellman  & 10000,10000 & 0.01 & - & - & - \\ \hline
DQN-AL  & 10000,10000 & 0.001 & 0.1 & - & - \\ \hline
\begin{tabular}[c]{@{}l@{}}DQN-AL with \\ Scheduled Shared Experience\end{tabular}  & 10000,10000 & 0.001 & 0.9 & 0.05 & 500  \\ \hline
Dueling DQN-AL  & 2000,10000 & 0.001 & 0.1 & - & - \\ \hline
\begin{tabular}[c]{@{}l@{}}Dueling DQN-AL with \\ Scheduled Shared Experience\end{tabular}  & 2000,10000 & 0.001 & 0.9 & 0.05 & 500  \\ \hline
DRQN-AL  & 10000,100000 & 0.001 & 0.25 & - & - \\ \hline
\end{tabular}
\end{table}
...
DAL with Bellman  & 10000,10000 & 0.01 & - & - & - \\ \hline
DQN-AL  & 10000,10000 & 0.001 & 0.1 & - & - \\ \hline
\begin{tabular}[c]{@{}l@{}}DQN-AL with \\ Scheduled Shared Experience\end{tabular}  & 10000,10000 & 0.001 & 0.05 & 500 &  \\ \hline
Dueling DQN-AL  & 10000,10000 & 0.1 & 0.1 & - &  -\\ \hline
\begin{tabular}[c]{@{}l@{}}Dueling DQN-AL with \\ Scheduled Shared Experience\end{tabular}  & 10000,10000 & 0.1 & 0.9 & 0.05 & 500 \\ \hline
DRQN-AL  & 10000,100000 & 0.001 & 0.25 & - & - \\ \hline
\end{tabular}
\end{table}
