...
DAL with Bellman & F & 10000,10000 & 0.01 & - & - & - \\ \hline
DQN-AL & F & 10000,10000 & 0.001 & 0.1 & - & - \\ \hline
\begin{tabular}[c]{@{}l@{}}DQN-AL with \\ Scheduled Shared Experience\end{tabular} & F & 10000,10000 & 0.001 &  &  &  \\ \hline
...
The results for the task understanding tests are shown in Table~\ref{tab:task-understanding}.  As shown, all the networks show poor performance for task understanding.  The DQN architectures do outperform the DAL architectures, but do not display largely significant results.
\begin{table}[]
\centering
